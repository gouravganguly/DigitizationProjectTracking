...
<form  method="post" action="server.php">
		...
		<select class="input100" type="text" name="file_no">
			...
			<?php
				$sql = "select file_no from inward_data";
	...
	<!--	<div class="wrap-input100 ">
			<input class="input100" type="number" min="0" name="total" placeholder="Total">
			<span class="focus-input100"></span>
			<span class="symbol-input100">
				<i class="fa fa-lock" aria-hidden="true"></i>
			</span>
...
-->
		...
		<div class="container-login100-form-btn">
			<input type="submit" class="login100-form-btn" value="Submit" name="submit3" />
		</div><br>
		<div>
			<a href="update_doc_prep.php">Update</a>
		</div>
		<div class="text-center p-t-136">
			<a class="txt2" href="inward.php">
